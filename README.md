...
- **Problem:** Im Alltag fehlt eine einfache, übersichtliche Möglichkeit, persönliche Aufgaben tagesgenau zu planen und zu verwalten. Bestehende Tools sind oft zu komplex oder nicht auf den täglichen Planungsrhythmus ausgerichtet.
- **Ziele:** Aufgaben erfassen, bearbeiten, verschieben und als erledigt markieren  
- **Primäre Zielgruppe:** Studierende und Berufstätige, die ihren Alltag strukturieren wollen und eine schnelle, leichtgewichtige Task-App suchen. 
...
- **Kernfunktionalität:** 
  - Aufgabe erstellen (Titel, Beschreibung, Kategorie, Datum, Notiz)
  - Aufgabe bearbeiten und löschen
  - Aufgabe auf ein anderes Datum verschieben
  - Aufgabe als erledigt markieren
  - Tagesansicht: alle Aufgaben eines Datums im Detail
  - Wochenansicht: Überblick über 7 Tage
  - Dashboard: tagesbezogene Übersicht mit Kennzahlen  
- **Annahmen [Optional]:** Nutzer:innen wollen ihre Aufgaben primär nach Datum strukturieren, nicht nach Projekten oder Prioritäten.
- **Abgrenzung [Optional]:** Keine Erinnerungsfunktion, keine Zusammenarbeit mit anderen Personen, kein externes Kalender-Sync (z. B. Google Calendar).

## 3. Vorgehen & Artefakte
Die Durchführung erfolgt phasenbasiert; dokumentieren Sie die wichtigsten Ergebnisse je Phase.

### 3.1 Understand & Define
- **Zielgruppenverständnis:** Recherche zu bestehenden Task-Apps (Todoist, Notion, Apple Reminders). Kernproblem: entweder zu mächtig (viele Features, steile Lernkurve) oder zu simpel (keine Kalenderintegration). Zielgruppe möchte tagesbasierte Planung ohne Overhead.
- **Wesentliche Erkenntnisse:** 
  - Nutzer:innen wollen Aufgaben einem konkreten Tag zuordnen
  - Wochenüberblick ist wichtig für Vorausplanung
  - Kategorien (Arbeit / Schule / Privat) helfen bei der mentalen Trennung
  - Schnelles Erfassen und Abhaken sind die häufigsten Aktionen
